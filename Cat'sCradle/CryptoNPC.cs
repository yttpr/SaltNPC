...
namespace Cat_sCradle
{
  public static class CryptoNPC
  {
    ...
    {
      get => ResourceLoader.LoadSprite("sigisWalk.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
    }
    ...
    {
      string str = "SigisRoom";
      string key1 = "SigisConvo";
      string key2 = "SigisEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/CryptoGuy/CryptoRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = CryptoNPC.Script;
      instance1.startNode = "Salt.Crypto.Start";
      ...
      instance2.signType = (SignType) 775015;
      ...
      instance3.speakerName = "Sigis" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "Sigis" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "event:/Characters/Bosses/Osman Sinnoks/Phase 2/CHR_BOSS_OsmanSinnoks_P2_Dth",
        portrait = CryptoNPC.Front,
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775015, CryptoNPC.WNPivot);
  }
}
