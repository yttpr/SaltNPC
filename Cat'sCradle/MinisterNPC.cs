...
namespace Cat_sCradle
{
  public static class MinisterNPC
  {
    ...
    {
      get => ResourceLoader.LoadSprite("GiggleIcon.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
    }
    ...
    {
      get => Data.Assets.LoadAsset<YarnProgram>("assets/MinisterGuy/giggle.yarn");
    }

    public static void Giggle()
    {
      string str = "MinisterRoom";
      string key1 = "MinisterConvo";
      string key2 = "MinisterEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/MinisterGuy/MinisterRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = MinisterNPC.Script;
      instance1.startNode = "Salt.Giggle.Start";
      ...
      instance2.signType = (SignType) 774996;
      ...
      instance3.speakerName = "Minister" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "Minister" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "event:/Characters/Enemies/GigglingMinister/CHR_ENM_GigglingMinister_Roar",
        portrait = MinisterNPC.Front,
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 774996, MinisterNPC.WNPivot);
  }
}
