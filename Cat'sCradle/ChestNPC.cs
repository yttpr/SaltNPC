...
namespace Cat_sCradle
{
  public static class ChestNPC
  {
    ...
    {
      get => ResourceLoader.LoadSprite("Chest.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
    }
    ...
    {
      get => Data.Assets.LoadAsset<YarnProgram>("assets/ChestGuy/chest.yarn");
    }

    public static void Troll()
    {
      string str = "FakeChestNPCRoom";
      string key1 = "FakeChestNPCConvo";
      string key2 = "FakeChestNPCEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/ChestGuy/ChestRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = ChestNPC.Script;
      instance1.startNode = "Salt.Chest.Start";
      ...
      instance2.signType = (SignType) 775005;
      ...
      instance3.speakerName = "ChestGuy" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "ChestGuy" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "event:/Characters/Player/Boyle/CHR_PLR_Boyle_Dx",
        portrait = ChestNPC.Front,
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775005, ChestNPC.WNPivot);
  }
}
