...
namespace Cat_sCradle
{
  public static class WeedNPC
  {
    ...
    {
      get => ResourceLoader.LoadSprite("miniweed.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
    }
    ...
    {
      get => Data.Assets.LoadAsset<YarnProgram>("assets/WeedGuy/weed.yarn");
    }

    public static void Smoke()
    {
      string str = "CannibisRoom";
      string key1 = "CannibisConvo";
      string key2 = "CannibisEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/WeedGuy/WeedRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = WeedNPC.Script;
      instance1.startNode = "Salt.Weed.Start";
      ...
      instance2.signType = (SignType) 775021;
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775021, WeedNPC.WNPivot);
  }
}
