...
namespace Cat_sCradle
{
  public static class LostNPC
  {
    ...
    {
      get => ResourceLoader.LoadSprite("lost.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
    }
    ...
    {
      get => Data.Assets.LoadAsset<YarnProgram>("assets/LostGuy/lost.yarn");
    }

    public static void Found()
    {
      string str = "LostNPCRoom";
      string key1 = "LostNPCConvo";
      string key2 = "LostNPCEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/LostGuy/LostRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = LostNPC.Script;
      instance1.startNode = "Salt.Lost.Start";
      ...
      instance2.signType = (SignType) 775008;
      ...
      instance3.speakerName = "Lost" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "Lost" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "",
        portrait = LostNPC.Front,
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775008, LostNPC.WNPivot);
  }
}
