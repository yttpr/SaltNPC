...
namespace Cat_sCradle
{
  public static class MagicNPC
  {
    public static Sprite World
    {
      get
      {
        return ResourceLoader.LoadSprite("Lobothomas_Overworld.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
      }
    }
    ...
    {
      string str = "MagicRockRoom";
      string key1 = "MagicRockConvo";
      string key2 = "MagicRockEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/MagicGuy/MagicRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = MagicNPC.Script;
      instance1.startNode = "Salt.Magic.Start";
      ...
      instance2.signType = (SignType) 775011;
      ...
      instance3.speakerName = "Lobothomas" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "Lobothomas" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "event:/Characters/Enemies/DLC_01/GlidedGulper/CHR_ENM_GlidedGulper_Dmg",
        portrait = MagicNPC.Front,
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775011, MagicNPC.WNPivot);
  }
}
