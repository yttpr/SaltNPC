...
namespace Cat_sCradle
{
  public static class FishNPC
  {
    public static Sprite World
    {
      get
      {
        return ResourceLoader.LoadSprite("fishoverworld.png", 32, new Vector2?(new Vector2(0.5f, 0.0f)));
      }
    }
    ...
    {
      get => Data.Assets.LoadAsset<YarnProgram>("assets/FishGuy/fish.yarn");
    }

    public static void Bowl()
    {
      string str = "FreddyGoldfishRoom";
      string key1 = "FreddyGoldfishConvo";
      string key2 = "FreddyGoldfishEncounter";
      NPCRoomHandler npcRoomHandler = Data.Assets.LoadAsset<GameObject>("assets/FishGuy/FishRoom.prefab").AddComponent<NPCRoomHandler>();
      ...
      instance1.dialog = FishNPC.Script;
      instance1.startNode = "Salt.Fish.Start";
      ...
      instance2.signType = (SignType) 775007;
      ...
      instance3.speakerName = "Freddy" + PathUtils.speakerDataSuffix;
      ((Object) instance3).name = "Freddy" + PathUtils.speakerDataSuffix;
      instance3._defaultBundle = new SpeakerBundle()
      {
        dialogueSound = "",
        portrait = FishNPC.Front,
        bundleTextColor = Data.Dimitri
      };
    ...
    public static void Add() => BrutalAPI.BrutalAPI.AddSignType((SignType) 775007, FishNPC.WNPivot);
  }
}
